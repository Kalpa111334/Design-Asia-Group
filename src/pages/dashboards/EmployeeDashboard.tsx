      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Welcome back! Here's what's happening with your tasks and activities.</p>
          </div>
          <div className="flex gap-2">
            ...
            <Button onClick={() => navigate('/petty-cash')} variant="outline">
